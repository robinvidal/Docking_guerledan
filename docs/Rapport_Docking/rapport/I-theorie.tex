...
Cependant, la présence d'un grillage métallique dans le fond de la cage génére des échos reconnaissables à une profondeur spécifique formant un motif caractéristique. Ainsi, l'exploitation de ce phénomène demeure une piste envisageable pour améliorer la robustesse de la détection.

Pour appuyer cette configuration, une configuration expérimentale a été mise en place en bassin, où la cage a vu 3 de ses faces recouvertes de panneaux acoustiquement absorbants (PVC) et celles-ci ont été entourées de cordages qui eux sont au contraire très réfléchissants. Cette disposition vise à minimiser les échos parasites et à renforcer la signature caractéristique (carrée) de la cage.
