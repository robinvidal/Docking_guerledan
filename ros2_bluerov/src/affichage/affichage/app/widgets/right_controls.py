...
class RightControlsPanel(QWidget):
    """Panneau de contrôles empilés pour filtres polaires, cartésiens, sonar mock et tracker."""
    ...
    def __init__(self, ros_node):
        ...
        for btn in (self.polar_btn, self.cartesian_btn, self.sonar_btn, self.tracker_btn):
    ...
    def set_view(self, index):
        ...
        buttons = (self.polar_btn, self.cartesian_btn, self.sonar_btn, self.tracker_btn)
