"""
Contrôleur pour la mission de docking - Identique à la simulation
Reproduit la logique de bluerov_simulation.py pour un comportement réel/simu cohérent
"""
...
class CageFollowController:
    ...
    def control_step(self, obs1, obs2):
        ...
        if not both_visible:
            # ========== ÉTAT 1: SEARCH ==========
            # Tourner jusqu'à voir les deux bouées
            self.state = "search"
